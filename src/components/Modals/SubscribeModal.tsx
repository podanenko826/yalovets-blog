        ...
        <div className={`${styles.fullScreenModal} ${styles.previewModal}`} onClick={() => handleClose()}>
            <div className="container">
                {subscribeStatus !== null && (
                    <div
                        className={`${styles.dialogBox} ${styles.subscribeModal} ${subscribeStatus ? styles.dialogBox_green : styles.dialogBox_red} p-5`}
                        onClick={e => {
                            e.stopPropagation();
                ...
                <div className={`${styles.postDataContainer} ${styles.subscribeModal}`} onClick={e => e.stopPropagation()}>
                    ...
                    <div className="my-5 px-1">
                        <h1 className="heading-large text-left" id="col-heading-1">
                            Stay informed.
                        </h1>
                    ...
                    <form action="POST">
                        <div className="my-4">
                            ...
                            <div className="d-flex">
                                ...
                                <p className="p-2">
                                    Subscribe me to the newsletter featuring new content, product news, and service updates. I acknowledge that email performance is tracked through opens and clicks and agree to the{' '}
                                    <Link className="a-link a-btn" id="col-secondary" href={'/privacy-policy'}>
                                        privacy policy.
                                    </Link>
                                </p>
                            </div>
                        ...
                        <div className="d-flex justify-content-start gap-3">
                            <button type="button" className={`btn-filled btn-full py-3 px-4 ${isSubscribeDisabled && 'btn-disabled'}`} disabled={isSubscribeDisabled} onClick={handleSubscribeClick}>
                                Subscribe
                            </button>
                        </div>
                    </form>
