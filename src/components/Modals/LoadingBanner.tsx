...
const LoadingBanner = () => {
    ...
    return (
        <div style={{ width: "100%", height: "100vh", display: "flex", justifyContent: "center", alignItems: "center", position: "fixed", background: "var(--col-background)", overflow: "hidden", zIndex: 10000, top: "0%", left: "0%" }}>
